class PredictionsController < ApplicationController
  ...
  def edit
  @ufc = Ufc.find(params[:ufc_id])
  @prediction = Prediction.find(prediction_params)
  end
  ...
  def create
    ...
    @ufc = Ufc.find(params[:ufc_id])
    @prediction = @ufc.predictions.build(prediction_params)
        respond_to do |format|
      if @prediction.save
        format.html { redirect_to ufc_prediction_path(@ufc, @prediction), notice: 'Prediction was successfully created.' }
  ...
  private
    ...
    def prediction_params
      params.require(:prediction).permit( :ufc, :fighter, :how, :when)
    end
end
